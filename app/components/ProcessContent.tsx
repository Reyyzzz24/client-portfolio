      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            className="hidden md:block absolute top-[40px] left-0 w-full h-[1px] bg-gray-200 -z-0"
          />

          {steps?.map((step) => {
            const IconComponent =
              (Icons as any)[step.icon_name];
            ...
            return (
              ...
              >
                <motion.div
                  variants={icon}
                  className="bg-black p-5 rounded-full mb-6"
                >
                  {IconComponent && (
                    <IconComponent
                      size={24}
                ...
                <p className="text-gray-500 text-sm leading-relaxed max-w-[150px]">
                  {step.description}
                </p>
              </motion.div>
            );
